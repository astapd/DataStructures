...
public class AddressBook {
	...
	public static void main(String[] args) throws IOException {
		...
		if(open.equalsIgnoreCase("y")) {
			...
			System.out.println(" For example. My file path was : C:\\INFS 519 workspace\\INFS_519_Assignments\\src\\assignment\\three\\Assignment3_Text_File.txt\n");
		...
		while(!(selection.equals("q") )) {
			...
			case "a":
				System.out.println("Displaying the items in the address book (in In-order traversal)\n" );
				table.displayAll();
				break;
			...
			case "s":
				...
				filePath = sc.nextLine();
				table.save(filePath);
				System.out.println("Please see the file  for the saved address book (in pre-order traversal).\n");
				break;
